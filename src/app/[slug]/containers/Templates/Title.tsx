    ...
    <section className="relative w-full h-full">
      ...
      <div className="w-3/6 h-full flex flex-col items-center mt-[-40px] justify-center animate-init-fade-in-move md:mt-[-2.1vw]">
        <div className="ml-[-20px] max-w-[70%]">
          <h1 className="text-7xl text-fff font-bold lg:text-6xl md:text-[4vw] md:font-medium">
            {title}
          </h1>
          <div className="flex mt-6 md:mt-[1.5vw]">
            <div className="w-[2px] h-[18px] bg-fff mt-[6px] mr-4 md:w-px md:h-[1.2vw] md:mt-[0.65vw] md:mr-2" />
            <p className="text-lg text-fff lg:text-base md:text-[1.6vw] md:leading-relaxed">
              {description}
            </p>
          </div>

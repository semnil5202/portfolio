    ...
    return (
      <section className="relative w-full h-full flex justify-center items-center">
        <div className="flex flex-col items-center">
          <p className="text-7xl text-fff font-bold lg:text-6xl">{heading}</p>
          <div className="w-[30%] h-[2px] bg-fff mt-10 mr-4 lg:w-[25%]" />
        </div>
      </section>
    );
  }
    ...
    <section className="relative w-full h-full flex justify-center items-center">
      ...
      <Link href={`/${link}`} className="flex flex-col items-center">
        <div className="flex items-center">
          ...
          <p className="text-7xl text-fff font-bold mr-4 lg:text-6xl">
            {heading}
          </p>
          <SVGNextIcon />
        </div>

    ...
    <>
      <section className="w-full h-full px-[8%] pb-[4%] flex flex-col items-center md:px-[4%] md:pb-[1%]">
        <div className="w-full max-w-[1140px] h-[26%] flex flex-col justify-end lg:h-[20%] md:h-[14%]">
          <h2 className="text-4xl text-fff font-bold lg:text-3xl md:text-[2.2vw] md:leading-tight md:font-medium">
            {heading}
          </h2>
          <div className="w-[48px] h-[2px] bg-fff my-3 lg:my-2 lg:w-[36px] md:hidden" />
          {subHeading ? (
            <h4 className="text-lg text-fff font-extralight lg:text-base md:text-[1.3vw] md:leading-tight">
              {subHeading}
            </h4>
          ) : (

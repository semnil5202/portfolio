    ...
    details: [
      {
        ...
        solves: [
          ...
          '스크린 사이즈에 해당하는 마커들만 동적으로 렌더링함으로써 렌더링 프레임을 48fps에서 71fps로 개선하였습니다. (75fps 모니터 기준)',
        ],
        result: {
          description: {
            name: 'Pull Request',
    ...
    details: [
      {
        ...
        solves: [
          'MSW를 사용하여 Mock API를 만듦으로써 서버 의존성 없이 API 로직을 작성할 수 있도록 하였고, 추후 End Point만 교체하는 것으로 실제 서버와의 통신이 가능하도록 하였습니다.',
        ],
      },
      {
    ...
    details: [
      {
        ...
        solves: [
          'TypeScript를 활용하여 제네릭과 React의 ElementType, ComponentPropsWithoutRef 타입을 활용하여 다형성 컴포넌트를 구현함으로써, Tag에 따른 Attribute를 동적으로 지정할 수 있도록 하였습니다.',
        ],
      },
      {

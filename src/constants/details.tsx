      ...
      contents: [
        ...
        },
        {
          ...
          descriptions: [
            ...
            "Ref와 setTimeout 메서드를 활용하여 유저의 입력이 300ms 동안 없을 경우 자동으로 서버에 중복 검사 요청을 보내는 디바운싱 기능을 구현했습니다. 이를 통해 '닉네임 중복 확인'과 같은 버튼을 누를 필요 없이 보다 편리하게 닉네임 중복 검사를 수행할 수 있었습니다.",
          ],
        },
      ],
    },

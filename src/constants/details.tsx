        ...
        contents: [
          ...
          },
          {
            ...
            descriptions: [
              ...
              '폰트 최적화와 Vite의 rollupOptions 속성을 활용하여 번들 파일에 포함시키지 않을 외부의 라이브러리 의존성 목록을 지정했습니다. 이를 통해 4.76MB이던 패키지 사이즈를 2.19MB로 축소시켰고 서비스 LCP를 약 1.6초 개선할 수 있었습니다.',
            ],
          },
        ],
      },
      ...
      contents: [
        {
          heading: '요구 사항',
          descriptions: [
            "댓글 목록을 한 번에 불러올 경우 긴 로딩 시간을 갖게 될 것 같았고, 나눠서 불러올 경우 유저가 '더 보기' 버튼을 반복적으로 클릭해야 하는 불편함이 예상되었습니다.",
        ...
        },
        {
          ...
          descriptions: [
            ...
            'Ref와 브라우저의 resize 이벤트를 통해 유저의 키보드 높이를 파악하여 답글 입력창이 키보드에 가려지지 않도록 포커싱 기능을 구현했습니다. 또한 OS별로 포커싱 기능을 분기 적용하여 PC, Android, iOS 환경에서 최적의 사용성을 제공했습니다.',
          ],
        },
      ],
      link: {
      ...
      contents: [
        {
          heading: '요구 사항',
          descriptions: [
            '정책상 닉네임은 필수로 입력해야하고, 두 글자 미만으로 작성할 수 없으며, 특수문자를 포함할 수 없습니다. 이런 사항들을 일일이 설명하기엔 회원 가입 Form이 너무 복잡해질 것 같았고, 제출 버튼을 누른 뒤 잘못 입력한 값에 대한 피드백을 주게 되면 입력했던 값을 다시 수정해야하는 불편함이 예상되었습니다.',

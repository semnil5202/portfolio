        ...
        contents: [
          {
            heading: '문제 상황',
            descriptions: [
              '여러 명의 개발자가 거쳐가면서 제각각의 코드 컨벤션과 중복 코드로 인해 가독성이 좋지 않았고, 컴포넌트에 여러 로직이 몰려 있어 책임 분리가 모호했습니다.',
            ],
          },
          {
            heading: '해결 과정',
      ...
      contents: [
        ...
        },
        {
          ...
          descriptions: [
            ...
            'Ref와 setTimeout 메서드를 활용하여 유저의 입력이 300ms 동안 없을 경우 자동으로 서버에 중복 검사 요청을 보내는 디바운싱 기능을 구현해, 닉네임 중복 확인 버튼을 누를 필요 없이 편리하게 중복 검사를 수행할 수 있었습니다.',
          ],
        },
      ],
    },

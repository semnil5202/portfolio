...
export default function DynamicText({ texts }: Props) {
  ...
  return (
    <div className="flex w-max">
      <h2 className="text-5xl leading-snug text-primary-dark font-bold lg:text-[32px] lg:leading-normal md:text-[22px] md:leading-normal md:text-white md:font-medium">
        {currentText}
      </h2>
      <span
        className={`text-5xl leading-snug text-primary-dark ${
          !isTyping && 'animate-flickering'
        } lg:text-[32px] lg:leading-normal md:text-[22px] md:leading-normal md:text-white md:font-medium`}
      >
        |
      </span>
    </div>
